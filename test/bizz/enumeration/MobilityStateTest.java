...
public class MobilityStateTest {
    ...
    public void testValueOf() {
        ...
        assertEquals(MobilityState.valueOf("SECOND_PAYMENT_CLEARANCE"), MobilityState.SECOND_PAYMENT_CLEARANCE);
        assertEquals(MobilityState.valueOf("SECOND_PAYMENT_REQUESTED"), MobilityState.SECOND_PAYMENT_REQUESTED);
    }
}
